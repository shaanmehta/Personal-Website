  ...
  return <div className="relative min-h-screen overflow-hidden">
      ...
      <div className="relative z-10 min-h-screen flex flex-col items-center justify-center py-0 px-[27px]">
        ...
        duration: 0.8
          ...
          <TypingText lines={["Shaan Mehta", "Mechatronics Engineering student at the University of Waterloo"]} className="text-2xl md:text-4xl lg:text-5xl text-foreground leading-relaxed text-center" typingSpeed={70} delayBetweenLines={1000} />
        </motion.div>
